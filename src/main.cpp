...
uint256 hashGenesisBlock("0xb29fcc41ef1642453acde1624b3192c8352e9963bfe9f8a43de077a2199c4573");
...
int64 static GetBlockValue(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	// Subsidy is cut in half every 864000 blocks, which will occur every 5 years
	nSubsidy >>= (nHeight / 864000); 
...
static const int64 nTargetTimespan = 60 * 60;						// ZedCoin: every 60 mins
static const int64 nTargetSpacing = 3 * 60;								// ZedCoin: 3 min blocks
static const int64 nInterval = nTargetTimespan / nTargetSpacing;	// ZedCoin: 20 blocks re-target
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "January 16, 2014 — Hershey's to make 3-D chocolate printer";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x39c4b3e1b06755078e50be1f7a8da50c10542e7c22046f1b890a24c871debcf0"));
