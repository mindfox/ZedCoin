...
static const unsigned int MAX_TX_COMMENT_LEN = 140; // ZedCoin: 128 bytes + little extra

static const int64 MIN_TX_FEE = 1000000;
static const int64 MIN_RELAY_TX_FEE = MIN_TX_FEE;
static const int64 MAX_MONEY = 1000000000 * COIN; // ZedCoin: maximum of 1 billion coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 480 / 250; // ZedCoin: 480 blocks found a day. Priority cutoff is 1 zedcoin day / 250 bytes.
    }
